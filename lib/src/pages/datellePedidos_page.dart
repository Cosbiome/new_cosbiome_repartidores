...
class _DetallePedidoState extends State<DetallePedido> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<List<MapBoxPlace>> getPlaces() async {
      String busqueda =
          '${pedido.domicilio} ${pedido.colonia} ${pedido.ciudad} ${pedido.estadoProv} Mexico'
              .replaceAll('#', '');
    ...
    return Scaffold(
            ...
            Container(
              ...
              child: IconButton(
                  ...
                  onPressed: () async {
                    ...
                    Navigator.pushNamed(context, 'mapaEntrega',
                        arguments: cordenadas);
                  }),
            )
          ],
        ),
        body: ListView(
          ...
          children: [
            ListTile(
              tileColor: Color.fromRGBO(130, 130, 130, 0.1),
              title: Center(
                child: Text(
                  'Detalle del pedido',
              ...
              children: [
                ...
                AnimatedContainer(
                  ...
                  child: GestureDetector(
                    child: Text(
                        'Numero del cleinte: ${_telefono ? pedido.numTel : '0000000000'}',
                        style: TextStyle(fontSize: 18)),
                    onLongPressEnd: (LongPressEndDetails details) async {
                      FlutterPhoneDirectCaller.callNumber(
                          _telefono ? pedido.numTel : '0000000000');
                      setState(() {
                ...
                Text('Vendedor del cleinte: ${pedido.vendedor}',
                    style: TextStyle(fontSize: 16)),
                Divider(
                  color: Color.fromRGBO(103, 181, 30, 1.0),
                ),
                Text('Repartidor de entrega: ${pedido.repartidor}',
                    style: TextStyle(fontSize: 16)),
                Divider(
                  color: Color.fromRGBO(103, 181, 30, 1.0),
                ),
                Text('Entrega de ${pedido.de} - ${pedido.a}',
                    style: TextStyle(fontSize: 16)),
                Divider(
                  color: Color.fromRGBO(103, 181, 30, 1.0),
                ),
                Text('Metodo de pago: ${pedido.formaDePago}',
                    style: TextStyle(fontSize: 16)),
                Divider(
                  color: Color.fromRGBO(103, 181, 30, 1.0),
                ),
            ...
            ListBody(
              children: [
                Text('Direccion: ${pedido.domicilio}',
                    style: TextStyle(fontSize: 16)),
                Divider(
                  color: Color.fromRGBO(103, 181, 30, 1.0),
                ),
                Text('Cruces: ${pedido.cruces}',
                    style: TextStyle(fontSize: 16)),
                Divider(
                  color: Color.fromRGBO(103, 181, 30, 1.0),
                ),
                ...
                Text('Ciudad: ${pedido.ciudad}',
                    style: TextStyle(fontSize: 16)),
                Divider(
                  color: Color.fromRGBO(103, 181, 30, 1.0),
                ),
                Text('Estado: ${pedido.estadoProv}',
                    style: TextStyle(fontSize: 16)),
                Divider(
                  color: Color.fromRGBO(103, 181, 30, 1.0),
                ),
                Text('Codigo postal: ${pedido.codigoPostal}',
                    style: TextStyle(fontSize: 16)),
                Divider(
                  color: Color.fromRGBO(103, 181, 30, 1.0),
                ),
                    ...
                    ElevatedButton(
                      child: Container(
                        padding: EdgeInsets.symmetric(
                            horizontal: size.height * .03, vertical: 15.0),
                        child: Text('ENTREGAR'),
                      ),
                          ...
                          : () async {
                              try {
                                if (_formKey.currentState.validate()) {
                                  ...
                                  final pedidoJson =
                                      jsonEncode(pedido.toJson());
                                  await http.put(
                                      'https://cosbiome.online/pedidos-rutas/${pedido.id}',
                                      body: pedidoJson,
                                      headers: {
                      ...
                      onPressed: _isSubmit
                          ...
                          : () async {
                              try {
                                ...
                                //       'https://cosbiome.online/productos/?nombreProducto=${e.producto}');
                                //   List<dynamic> productoDecode2 =
                                //       json.decode(productoDB.body);
                                //   ProductosDb productoDecode =
                                //       new ProductosDb.fromJson(productoDecode2[0]);
                                //   int cantidadNeva =
                                //       int.parse(productoDecode.cantidadProducto) +
                                //           int.parse(e.cantidad);
                                //   productoDecode.cantidadProducto =
                                //       cantidadNeva.toString();
                                //   String id = productoDecode.id;

                                //   await http.put(
                                //       'https://cosbiome.online/productos/$id',
                                //       body: productosDbToJson(productoDecode),
                                //       headers: {
                                //         HttpHeaders.contentTypeHeader:
                                //             "application/json"
                                //       });
                                ...
                                await http.post(
                                    'https://cosbiome.online/preventa-calidads',
                                    body: pedidosToJson(pedido),
                                    headers: {
                                      HttpHeaders.contentTypeHeader:
                                          "application/json"
